...
namespace DDSS_LobbyGuard.Modules.Extras.CharacterNamesInLobby.Patches
{
    ...
    internal class Patch_PlayerLobbyUI
    {
        ...
        private static void Start_Postfix(PlayerLobbyUI __instance)
        {
            ...
            {
                // Clone playerName
                GameObject characterNameObj = Object.Instantiate(__instance.playerName.gameObject, __instance.playerName.transform.parent);
