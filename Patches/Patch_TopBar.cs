...
namespace DDSS_LobbyGuard.Patches
{
    ...
    internal class Patch_TopBar
    {
        ...
        private static bool UpdateDifference_Prefix(TopBar __instance)
        {
            ...
            // Validate Host
            if (!NetworkServer.activeHost || !ConfigHandler.Gameplay.EnforceComputerWindowBoundary.Value)
                return true;
            ...
            if (!shouldMove || !computer.isUsingComputer)
            {
